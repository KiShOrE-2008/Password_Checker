...
const vaultSchema = new mongoose.Schema({
  ...
  password: { type: String, required: true } // In production, this should be symmetrically encrypted
});
...
app.listen(PORT, () => console.log(`Server running with MongoDB Database on port ${PORT}`));
